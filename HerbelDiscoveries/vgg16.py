...
saved_model_path = 'model_multiclass_vgg16.h5'
...
# Create VGG16 model with pretrained weights (excluding top layers)
...
model = models.Sequential([
    ...
    layers.Dropout(0.5),
    layers.Dense(30, activation='softmax')  # Assuming 30 classes
])
